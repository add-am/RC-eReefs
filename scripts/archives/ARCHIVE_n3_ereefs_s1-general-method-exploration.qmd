...
if (file.exists(glue("{output_path}/chla_single.nc"))){
  
  #load data
  r <- rast(glue("{output_path}/chla_single.nc"))
...
if (exists("r")){#do nothing
  ...
  writeCDF(r, glue("{output_path}/chla_single.nc"))
...
n3_offshore <- n3_marine_region |> 
  filter(BasinOrZone == "Offshore")
